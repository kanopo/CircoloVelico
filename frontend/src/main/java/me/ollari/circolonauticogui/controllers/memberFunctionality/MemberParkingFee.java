...
public class MemberParkingFee {
    ...
    public void setTable() throws IOException, InterruptedException {
        ...
        if (getBoatsResponse.statusCode() == 200) {
            ...
            List<Boat> usersBoats = boatsMapper.readValue(getBoatsResponse.body(), new TypeReference<>() {
            });
            for (Boat b : usersBoats) {
                ...
                if (getBoatsResponse.statusCode() == 200) {
                    ...
                    List<ParkingFee> boatsParkingFees = parkingFeeMapper.readValue(getParkingFeesResponse.body(), new TypeReference<>() {
                    });
    ...
    public void renew(ActionEvent actionEvent) throws IOException, InterruptedException {
       ...
       if (boatName != null) {
           ...
           if (boatsOfMemberResponse.statusCode() == 200) {
               ...
               List<Boat> usersBoats = boatsMapper.readValue(boatsOfMemberResponse.body(), new TypeReference<>() {
               });
               ...
               if (feesForBoatRequest.statusCode() == 200) {
                   ...
                   List<ParkingFee> boatsFees = parkingFeesMapper.readValue(feesForBoatRequest.body(), new TypeReference<>() {
                   });
